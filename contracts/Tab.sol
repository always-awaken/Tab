...
contract Tab is ERC20, Ownable, Pausable{
    ...
    function giveBackTokens(address _token, uint256 _giveBackBalance) public onlyOwner {
        ...
        require(tokenBalance >= _giveBackBalance);

        address owner = msg.sender;
        token.transfer(owner, _giveBackBalance);
        emit GiveBackTokens(owner, _token, _giveBackBalance);
    }
}
